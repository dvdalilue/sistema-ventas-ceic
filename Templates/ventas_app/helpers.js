...
function isAlpha(parm) {return isValid(parm,_lwr+_upr+_caracteres_especiales);}
function isAlphanum(parm) {return isValid(parm,_lwr+_upr+_numb+_caracteres_especiales);}
